...
Fl_Menu_Item *MainWindowUI::m_file_connect_socket =
    MainWindowUI::menu_m_bar + 2;
...
MainWindowUI::MainWindowUI() {
  {
    ...
    { m_rate = new Fl_Output(270, 720, 50, 25, "Rate:"); } // Fl_Output* m_rate
    {
      m_interrogation_progress =
          new Fl_Progress(875, 724, 135, 21, "Interrogation");
    ...
    } // Fl_Group* m_table_editor_box
    {
      ...
      } // Fl_Group* o
      {
        ...
        o->box(FL_THIN_DOWN_BOX);
        {
          m_sensor_window_width =
              new Fl_Input(905, 325, 35, 25, "Capture Width");
        } // Fl_Input* m_sensor_window_width
        {
          m_sensor_window_total = new Fl_Input(905, 350, 35, 25, "Total Width");
        } // Fl_Input* m_sensor_window_total
        {
          m_sensor_window_offset =
              new Fl_Input(905, 375, 35, 25, "Window Start Offset");
    ...
    { m_save = new Fl_Button(550, 400, 70, 20, "Save"); } // Fl_Button* m_save
    {
